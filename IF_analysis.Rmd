...
You dont need to comment out my code chunks. Just don't run them when you are doing your analyses
...
ggplot(sum_sites, aes(x=total, y=mean_cover))+
  ...
  labs(x="Total Individuals Found", y="Fe Floc Percent Cover", color="Condition", shape="Sites")
...
ggplot(sum_sites, aes(x=biodiversity, y=mean_cover))+
  ...
  labs(x="Biodiversity Ratio", y="Fe Floc Percent Cover", color="Condition", shape="Sites")
```
