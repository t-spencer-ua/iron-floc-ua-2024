...
```{r}
ggplot(water_quality, aes(x=geo_order, y=temp, color=site_name))+
         geom_point()+
...
ggplot(water_quality, aes(x=geo_order, y=ferrous_iron, color=site_name))+
         geom_point()+
  geom_line(aes(linetype=site_name))+
  labs(x="Sequential Data along Streams", y="Dissolved Ferrous Iron (ppm)", color="Site Names", linetype="Site Names")

ggplot(water_quality, aes(x=geo_order, y=d_o, color=site_name))+
         geom_point()+
  geom_line(aes(linetype=site_name))+
...
ggplot(water_quality, aes(x=geo_order, y=conductivity, color=site_name))+
         geom_point()+
  geom_line(aes(linetype=site_name))+
  labs(x="Sequential Data along Streams", y="Conductivity (uS/cm)", color="Site Names", linetype="Site Names")

ggplot(water_quality, aes(x=geo_order, y=turbidity, color=site_name))+
         geom_point()+
  geom_line(aes(linetype=site_name))+
  labs(x="Sequential Data along Streams", y="Turbidity (cm)", color="Site Names", linetype="Site Names")
```

## Scatterplots of WQ data plotted against eachother to identify trendlines

how to remove nas? how to adjust scales? na.rm=TRUE doesn't work, the various scale commands also don't work
...
ggplot(water_quality, aes(x=ferrous_iron, y=percent_cover, na.rm=TRUE))+
  geom_point()
